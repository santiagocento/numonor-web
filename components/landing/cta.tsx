          ...
          <div className="grid gap-[var(--fds-space-2xl)] lg:grid-cols-[1.3fr_1fr]">
            <div>
              ...
              <div className="mt-[var(--fds-space-lg)] flex flex-wrap gap-[var(--fds-space-sm)]">
                <Button
                  ...
                  variant="primary"
                  size="lg"
                  className="bg-[var(--fds-neutral-bg-weaker)] text-[var(--fds-secondary-text-strong)]"
                >
                  <a href="https://play.numonor.app" target="_blank" rel="noopener noreferrer">
                    {primaryCta}
                  </a>
                </Button>
            ...
            <div className="grid gap-[var(--fds-space-sm)]">
              <StoreButton
                label={storeAppLabel}
                platform="App Store"
                href="https://apps.apple.com/us/app/numonor/id6758402964"
                icon={
